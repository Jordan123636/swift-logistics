...
function handleQuote() {
  ...
  window.location.href = 'auth.html';
    ...
    // Collect data - ready to send to Firebase
    const quoteData = {
      fullName: name,
    ...
    console.log('Quote request data (ready for Firebase):', quoteData);
    ...
    // Clear form
    ['fullName','company','email','phone','origin','destination','weight','details'].forEach(id => {
